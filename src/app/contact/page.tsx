  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['123 Book Street', 'Reading City, RC 12345', 'United States'],
    },
    {
      icon: Phone,
      title: 'Call Us',
    ...
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['support@bookhaven.com', 'sales@bookhaven.com', 'Response within 24 hours'],
    },
    {
      icon: Clock,
      title: 'Store Hours',
              ...
              <div className="bg-linear-to-br from-amber-100 to-orange-100 rounded-2xl overflow-hidden mb-6 h-80 border border-amber-200">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 font-medium">Map Integration Here</p>
                    <p className="text-sm text-slate-500">123 Book Street, Reading City</p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
              ...
              <p className="text-sm opacity-90 mb-4">Talk to our customer service team</p>
              <a href="tel:+15551234567" className="text-sm font-medium hover:underline">+1 (555) 123-4567</a>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
              <MessageSquare className="w-12 h-12 mx-auto mb-4 text-white" />
              <h3 className="text-xl font-semibold mb-2 text-white">Live Chat</h3>
              <p className="text-sm opacity-90 mb-4">Chat with us in real-time</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
              ...
              <p className="text-sm opacity-90 mb-4">Send us an email anytime</p>
              <a href="mailto:support@bookhaven.com" className="text-sm font-medium hover:underline">support@bookhaven.com</a>
            </div>
          </div>
        </div>
      </section>
