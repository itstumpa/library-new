...
<ul className="space-y-3">
            <div>
              <p className="text-slate-400 text-sm pb-1">123 Book Street, Reading City, RC 12345, USA</p>
              <p className="text-slate-400 text-sm pb-1">
                     Phone: +1 (555) 123-4567
              </p>
              <p className="text-slate-400 text-sm pb-1">Mon-Fri: 9AM - 6PM</p>
              <p className="text-slate-400 text-sm pb-1">Mail: support@bookhaven.com</p>
            </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <Image src="https://upload.wikimedia.org/wikipedia/commons/0/04/Visa.svg" width={30} height={100} alt="Visa" className="h-6 opacity-70" />
              <Image src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" width={30} height={100} className="h-6 opacity-70" />
              <Image src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" width={30} height={100} alt="PayPal" className="h-6 opacity-70" />
              <Image src="https://upload.wikimedia.org/wikipedia/commons/f/fa/American_Express_logo_%282018%29.svg" alt="Amex" width={30} height={100} className="h-6 opacity-70" />
            </div>
          </div>
        </div>
      </div>
