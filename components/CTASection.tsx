...
import { ArrowRight, Mail, Shield, Sparkles, Star, Zap } from "lucide-react";
...
export default function CTASection() {
  ...
  return (
    <section
      id="cta-section"
      className="py-16 md:py-22 relative overflow-hidden bg-linear-to-b from-slate-950 via-slate-900 to-slate-950"
    >
      {/* Animated Background */}
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-orange-500/20 rounded-full blur-[128px] animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4  md:px-8 relative z-10">
        ...
        >
            ...
            <div className="relative bg-linear-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-amber-500/20 rounded-3xl p-8 md:p-16 shadow-2xl">
              ...
              <div className="text-center max-w-5xl mx-auto mb-10">
                ...
                >
                  ...
                  <span className="text-amber-400 font-bold">20% OFF</span> your
                  first order
                </p>
                ...
                >
                  Plus exclusive deals, early access to new releases, and
              ...
              <form
                ...
                style={{
                  animation: isVisible
                    ? "scaleIn 0.6s ease-out 0.6s both"
                    : "none",
                }}
              >
          ...
          <div
            ...
            style={{
              animation: isVisible
                ? "fadeInUp 0.6s ease-out 1.2s both"
                : "none",
            }}
          >
            <p className="text-slate-400 text-sm">
              ...
              who get exclusive book deals every week
            </p>
          </div>
        </div>
      </div>
