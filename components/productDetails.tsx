...
export default function ProductDetails() {
  ...
  return (
    <div className=" bg-linear-to-br from-amber-50 via-white to-orange-50">
      ...
      <div className="max-w-7xl md:px-8 mx-auto px-4 py-12 md:py-32">
        {/* Breadcrumb */}
        ...
        {/* Product Section */}
        <div className="grid lg:grid-cols-3  gap-12 mt-12 mb-6">
          {/* Images */}
          <div
          ...
          >
            ...
            <div className="relative aspect-square bg-linear-to-br from-amber-50 to-orange-50 rounded-2xl overflow-hidden mb-4 border border-amber-200">
              ...
              />
              {discount > 0 && (
                <div className="absolute top-4 left-4 bg-linear-to-r from-orange-500 to-red-500 text-white px-4 py-2 rounded-full text-sm font-bold">
                  {discount}% OFF
                </div>
              )}
            </div>
              ...
              {(["description", "specifications", "reviews"] as const).map(
                (tab) => (
                  ...
                  >
                    {tab}
                    {activeTab === tab && (
                      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-amber-600 to-orange-600" />
                    )}
                  </button>
                ),
              )}
          ...
          <div className="bg-white rounded-xl border border-amber-200 p-8">
            {activeTab === "description" && (
              <div>
                ...
                {product.author && (
                  <div className="mt-6 p-6 bg-linear-to-br from-amber-50 to-orange-50 rounded-lg">
                    <h4 className="font-semibold text-slate-900 mb-2">
                      About the Author
                    </h4>
                    <p className="text-slate-700">
                      {product.author} is a renowned author known for compelling
                      storytelling.
                    </p>
                  </div>
                )}
                  ...
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="border-b border-slate-200 pb-6">
                      <div className="flex items-center gap-4 mb-3">
                        <div className="w-12 h-12 bg-linear-to-br from-amber-100 to-orange-100 rounded-full flex items-center justify-center">
                      ...
                      <p className="text-slate-700">
                        Excellent product! Highly recommend to anyone looking
                        for quality.
                      </p>
                    </div>
                  ))}
