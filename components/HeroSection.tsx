        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 sm:order-1 space-y-6 md:space-y-8">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-amber-100 border border-amber-200">
                ...
                <span className="text-xs md:text-sm font-medium text-amber-800">
                  Rated 4.8/5 by{" "}
                  <span className="hidden sm:inline">100K+ </span>Customers
                </span>
              </div>
              ...
              <p className="text-base md:text-lg lg:text-xl text-slate-600 leading-relaxed">
                Discover premium books, elegant stationery, and quality
                supplies. Fast shipping, competitive prices, and exceptional
                service guaranteed.
              </p>
            </div>
            ...
            >
              ...
              <Link href="/books" className="hidden sm:flex w-full sm:w-auto">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto h-11 md:h-12 px-6 md:px-8 border-amber-300 text-amber-700 hover:bg-amber-50 text-sm md:text-base"
                >
          ...
          <div className="order-1 lg:order-2 relative mt-8 lg:mt-0">
            <div
              ...
              style={{
                animation: isVisible ? "slideIn 1s ease-out 0.4s both" : "none",
              }}
            >
                              ...
                              <div className="flex items-center justify-between ">
                                <div className="flex gap-0.5 md:gap-1">
                                  {[...Array(5)].map((_, j) => (
                                    <Star
                                      key={j}
                                      className="w-3 h-3 md:w-4 md:h-4 text-amber-500 fill-amber-500"
                                    />
                                  ))}
                                </div>
                                <div className="text-xs sm:text-sm md:text-base font-bold text-amber-700">
