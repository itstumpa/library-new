...
import { Eye, Filter, Grid, Heart, List, ShoppingCart } from "lucide-react";
      ...
      <div className="max-w-7xl md:px-8 mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Browse our complete collection of {products.length} premium books
          ...
          {filteredProducts.map((product, index) =>
            viewMode === "grid" ? (
              ...
              <div
                ...
                style={{
                  animation: isVisible
                    ? `scaleIn 0.6s ease-out ${0.3 + index * 0.05}s both`
                    : "none",
                }}
