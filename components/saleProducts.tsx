...
export default function SaleProducts() {
  ...
  return (
    <section
      id="sale"
      className=" bg-linear-to-br from-orange-50 via-white to-red-50 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 py-14">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Don&apos;t miss out on these amazing discounts! Save big on your
            favorite books and stationery
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-4/4 overflow-hidden bg-linear-to-br from-amber-50 to-orange-50">
                  ...
                  >
                    <Button
                      ...
                      size="sm"
                      className="bg-white text-slate-900 hover:bg-orange-100"
                    >
                ...
                <div className="p-5 space-y-3">
                  ...
                  {/* Add to Cart */}
                  <Button className="w-full bg-linear-to-r from-orange-500 to-red-500 hover:from-orange-700 hover:to-red-700 text-white">
